...
def detect_voice_option(user_input: str):
    ...
    if "availability" in text or "seat" in text or "train" in text:
        return "4"

    if "agent" in text or "customer care" in text or "support" in text:
        return "5"
    ...
    if current_state == "menu":
        ...
        if user_input in menu:
            ...
            if user_input == "5":
                ...
                return {
                    "text": """Connecting you to IRCTC Customer Care Agent...

                    All agents are currently busy.

                    Please wait while we transfer your call.

                    Thank you for contacting IRCTC."""
                }
